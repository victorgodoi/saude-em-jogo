      ...
      <div className='contentHome'>
        ...
        <div id='home'>
          <div className='divHome'>
            ...
            <p className='welcome'>Seja Bem - Vindo {nameUser}!</p>
            <p className='textHome'>Desenvolvemos uma plataforma interativa especialmente para idosos, com o objetivo de estimular a memória e promover a saúde mental de forma lúdica e envolvente. Nosso jogo da memória temático convida você a combinar imagens de emojis relacionados à saúde, criando momentos de diversão e conexão.</p>
